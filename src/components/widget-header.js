import OpenCooperateDialog from "../commands/open-cooperate-dialog.js";
...
<a href = "/">
    ...
    <ul class = "flex back-dark widget-header-desktop-menu gap-5 hide-mobile">
        ...
        <li class = "text-md text-bold slow "><a href = "#contacts" class = "color-light">Контакты</a></li>
    </ul>
    <a href = "#" class = "button-cooperate text-md text-bold widget-header-cooperate hide-mobile text-color-auto">Сотрудничать</a>
    ...
    <div class = "widget-header-mobile-menu hide-desktop gap-40 hide">
        ...
        <a href = "#" class = "button-cooperate text-lg text-bold main-border">Сотрудничать</a>
    </div>
`
...
export default class WidgetHeader extends HTMLElement {
    ...
    render() {
        ...
        this.querySelector(".button-cooperate").addEventListener("click", () => {
            const command = new OpenCooperateDialog()
            command.execute()
        })
    }
}